...
var completionCmd = &cobra.Command{
	...
	Long: `Generate shell completion script for virtbench.
...
PowerShell:
  PS> virtbench completion powershell | Out-String | Invoke-Expression

  # To load completions for every new session, run:
  PS> virtbench completion powershell > virtbench.ps1
